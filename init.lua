	...
	},
	{
		...
		config = function()
			require("nvim-autopairs").setup({
				map_cr = true, -- makes Enter behave correctly inside {}
			})
		end,
	},
	{
	...
	{ -- Autocompletion
		...
		opts = {
			keymap = {
				...
				-- remove signature toggle from <C-k>
				["<C-k>"] = {},

				-- optional: move signature to Alt-k
	...
	},
	{
		...
		config = function()
			require("onedark").setup({
				style = "darker",
				transparent = true, -- keep terminal background
			})
